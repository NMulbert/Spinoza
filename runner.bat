...
Start /B dapr run --app-id questionaccessor --app-port 5002 --dapr-http-port 50002 -- dotnet run --project %spinoza_root%\backend\Accessors\Spinoza.Backend.Accessor.QuestionCatalog --urls http://localhost:5002
